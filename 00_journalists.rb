...
# Array de journalistes

# La taille de l'array
puts "Combien y a-t-il de journalistes dans ce array ? "

puts "Il y a #{journalistes.size} journalistes" #le .size permet de connaitre le nombre que contient le tableau
puts

# le nombre de handle ayant un numéro
puts "Combien d'handle contiennent un numéro ?"
puts "Il y a #{journalistes.count{|x| x[/\d+/]}} handle."
puts

# le nombre de handle ayant les 4 lettres du prénom 'Aude' à la suite
...
tab_ = []
tab_ += journalistes.grep(/_/)
puts "Il y a #{tab_.size} handles qui contiennent '_'"
puts
